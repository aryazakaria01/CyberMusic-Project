...
BG_IMAGE = getenv("BG_IMAGE", "https://telegra.ph/file/3231a19b55ea6085c3a08.jpg")
admins = {}
...
OWNER = getenv("OWNER", "@Badboyanim")
SOURCE_CODE = getenv("SOURCE_CODE", "t.me/CyberSupportGroup")
